...
public class Tortoise extends Racer
{
 ...
 /** draws a hat on the Tortoise if the Tortoise wins the race
 *	@param
 */
@Override
   public void morph( Graphics g) {
	    ...
	    g.fillRect(startX-4, startY-7, 6, 12);
	    g.fillRect(startX-6, startY+4, 10, 2);
	    g.setColor(Color.CYAN);
	    g.fillRect(startX-4, startY+1, 6, 2);
	}
}
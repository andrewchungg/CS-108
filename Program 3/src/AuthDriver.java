...
public class AuthDriver {
	...
	public static void main(String[] args) {
	      ...
	      AuthoringAssistantPlus auth = new AuthoringAssistantPlus();	// create object reference auth
	      ...
	      while (menuChoice != 'q') {
	         ...
	         if (menuChoice == 'c') {
	            ...
	            // menuChoice = ' ';
	        	 ...
	        	 String wordToReplaceWith = scnr.nextLine();
	        	 System.out.println(" " + wordToFind);
	        	 inputString = auth.findAndReplace(wordToFind, wordToReplaceWith);
	        	 System.out.println("Edited text: " + inputString);
	         }
